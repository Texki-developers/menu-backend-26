...
export class ProductController {
  ...
  async createProduct(@Body() dto: CreateProductDto, @OrgId() orgId: string, @BranchId() branchId: string) {
  ...
  async getAllProducts(@Query() dto: GetAllProductsDto, @OrgId() orgId: string, @BranchId() branchId: string) {
    return this.productService.getAllProducts(dto, orgId, branchId);
  }
  ...
  async downloadProductsCsv(@Res() res: any, @OrgId() orgId: string, @BranchId() branchId: string) {
    return this.productService.downloadProductsCsv(res, orgId, branchId);
  }
  ...
  async getProductById(@Param('id') id: string, @OrgId() orgId: string, @BranchId() branchId: string) {
    return this.productService.getProductById(id, orgId, branchId);
  }
  ...
  @ApiResponse({ status: HttpStatus.OK, type: Product })
  async updateProduct(@Param('id') id: string, @Body() dto: UpdateProductDto, @OrgId() orgId: string, @BranchId() branchId: string) {
    return this.productService.updateProduct(id, dto, orgId, branchId);
  }

  @Delete(':id')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Soft-delete a product', description: 'Sets is_deleted=true, is_active=false' })
  async deleteProduct(@Param('id') id: string, @OrgId() orgId: string, @BranchId() branchId: string) {
    return this.productService.deleteProduct(id, orgId, branchId);
  }
}
